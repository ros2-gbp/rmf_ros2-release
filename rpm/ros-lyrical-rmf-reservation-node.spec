...
%global pkg_name rmf_reservation_node
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-rmf-reservation-node
Version:        2.13.0
Release:        1%{?dist}
...
%changelog
* Mon Jun 15 2026 Arjo Chakravarty <arjoc@intrinsic.ai> - 2.13.0-1
- Autogenerated by Bloom

* Wed Apr 29 2026 Arjo Chakravarty <arjoc@intrinsic.ai> - 2.12.0-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Arjo Chakravarty <arjoc@intrinsic.ai> - 2.12.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Arjo Chakravarty <arjoc@intrinsic.ai> - 2.12.0-1
- Autogenerated by Bloom
